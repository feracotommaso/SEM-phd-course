...
# Exercise 4 — Stress test: increase missingness to ~40%
...
# Exercise 5 — (Optional) MNAR simulation: when FIML/MI can still be biased
...
# Exercise 6 — Reporting paragraph (deliverable)
