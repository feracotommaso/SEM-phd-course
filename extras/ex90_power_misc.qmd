...
::: {.center}
![](../assets/images/power/forimg.gif){width=55%}
:::

<!-- original output file name in Rnw: imgs/forimg.gif -->
...
<!-- original figure name in Rnw: imgs/abandon -->
...
<!-- original figure name in Rnw: imgs/dynamicresults -->
