...
@beaujeanLatentVariableModeling2014
:::
:::::
...
:::::: {style="font-size:0.70em; line-height:0.75;"}
::::: {columns}
::: {.column width="50%"}
```{r}
## ----------------------------
...
-   RI-CLPM and LCS families (they answer different questions)
    ...
    -   **Not yet available extras**
        ...
        → **RI-CLPM warnings & alternatives:** `extras/riclpm_vs_clpm.qmd`

        → **Latent change score models:** `extras/latent-change-score_models.qmd`

------------------------------------------------------------------------

## Exercises → Lab09

In **Lab09 (**[link](https://feracotommaso.github.io/SEM-phd-course/labs/lab09_longitudinal_growth.html)**)** you will:
