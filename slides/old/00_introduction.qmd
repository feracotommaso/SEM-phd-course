...
8.  Models for ordinal data
9.  Other miscellaneous topics (interactions, power analysis, MASEM)
...
```{r}
#| eval: false
install.packages(c("lavaan", "semTools", "semPlot", # IMPORTANT
                   "modsem", "MASS")) # FACULTATIVE
```
...
-   We will probably do live coding when needed. I will eventually upload those data on github.
...
formulation and graphically depicted (getting
...
Lin (youtube [course](https://www.youtube.com/watch?v=2M6VQY_OFvM))
