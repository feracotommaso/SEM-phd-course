...
![](../assets/images/modelfit.png){height="5.0cm"}
...
## Quick example dataset (same structure as your Exercise 2)
...
(We formalize reporting in deck 06 + the course reporting checklist.)
...
```{r}
#| eval: false
res <- lavResiduals(fit, type = "cov")
names(res)
# res$cov     # observed and implied covariance matrices
# res$resid   # residual covariance matrix (S - Sigma_hat)
```
...
(We avoid “magic cutoffs”; interpret in context + patterns.)

---

## Step 5: model modification (the *dangerous* step)
...
## Modification indices: the Lagrange Multiplier idea
...
3. **Apply theory filter**  
   is the modification plausible and consistent with your construct/design?
...
![](../assets/images/memefit.png){height="5.6cm"}
