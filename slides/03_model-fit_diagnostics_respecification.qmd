...
-   **`labs/lab03_fit-diagnostics_MI_residuals.qmd`** [link](https://feracotommaso.github.io/SEM-phd-course/labs/lab03_fit-diagnostics_MI_residuals.html){target="_blank"}
...
-   Groskurth et al. [-@groskurthWhyWeNeed2024] — fit cutoffs depend on analysis characteristics
-   McNeish & Wolf [-@mcneishDynamicFitIndex2023] — pushing against universal cutoffs
-   [Dynamic fit index app](https://dynamicfit.app/connect/#/welcome) for exploring scenario-dependent thresholds
