...
All the next 'non-invariance' slides are inspired in large part from the following [blog post](https://www.the100.ci/2024/01/10/a-casual-but-causal-take-on-measurement-invariance/?fbclid=IwAR2kcAPkq0i1IZXntLkcbeSoU1D-Pb_R45VBhJ4EOZUmY_Cv3T0ne6-KbNE)
...
Metric invariance means that for each item, the loading of the factor on the item is the same in the two groups (or, more precisely, that we cannot reject the hypothesis that the loadings are the same).
...
[@beaujeanStructureCognitiveAbilities2012]
...
```{r}
#| eval: true
ptscal <- parameterTable(m_scal2); ptscal[ptscal$op == "~1",-1]
```
:::
...
A causal interpretation of invariance [@rohrerRethinkingMeasurementInvariance2025]
...
../labs/Lab 07 — Invariance (MG-CFA) [link](https://feracotommaso.github.io/SEM-phd-course/labs/lab07_invariance_mgcfa.html)
...
-   [Rohrer's blogpost:](https://www.the100.ci/2024/01/10/a-casual-but-causal-take-on-measurement-invariance/?fbclid=IwAR2kcAPkq0i1IZXntLkcbeSoU1D-Pb_R45VBhJ4EOZUmY_Cv3T0ne6-KbNE) A casual but causal take on measurement invariance
-   Partial invariance strategies and interpretability
-   [@maassenDireDisregardMeasurement2025]: How much is invariance disregarded?
-   lavaan tutorial: <https://lavaan.ugent.be/tutorial/groups.html>
-   And controversies that I don't like [@funderMIsgivingsMeasurementInvariance2024] [@robitzschWhyFullPartial2023]

------------------------------------------------------------------------

## Acknowledgments

Thanks to Gianmarco Altoé for his slides!

![](../assets/images/gianma.jpg){height="4.5cm"}
