...
subtitle: "Introduction, syntax, and practical examples in lavaan"
...
![](../assets/images/luca.png){height="4.5cm"}
...
::: {.column width="50%"}
![](../assets/images/cfa2.PNG){fig-align="center" width="75%"}
:::
:::::
...
::: center
![](../assets/images/modelfit.png){width="45%"}
:::
...
::: {.callout-note appearance="minimal"}
Within: when a unit is above its cluster mean on $(X)$, is it also above its cluster mean on $(Y)$?
:::
::::
:::::::
...
[@ryuLevelSpecificEvaluationModel2009; @hsuDetectingMisspecifiedMultilevel2015]
...
Note: Loadings are typically stronger at the between level because measurement error tends to accumulate at Level 1 [@hoxMultilevelAnalysisTechniques2017].
:::
...
::: {style="font-size:0.8em; line-height:1.15;"}
Hox [-@hoxMultilevelAnalysisTechniques2017] suggests a preliminary check:
...
round(rbind(null = lavInspect(fit_null,"fit")[f],
            ind  = lavInspect(fit_ind,"fit")[f],
            sat  = lavInspect(fit_sat,"fit")[f],
            mcfa = lavInspect(fit_mcfa,"fit")[f]), 3)
```
:::
...
::: {.callout-warning appearance="minimal"}
Remember: Loadings are typically stronger at the between level because measurement error tends to accumulate at Level 1 [@hoxMultilevelAnalysisTechniques2017].
:::
...
See [@MenghiniWorkplaceStressReal]
...
::: {style="font-size:0.70em; line-height:1.15;"}
...
```{r}
p <- parameterEstimates(fit3x3); p[p$op == "~~" & p$ci.lower < 0, ]
```

[@hoxMultilevelAnalysisTechniques2017; @kolenikovTestingNegativeError2012]
...
[@jakRelatingMeasurementInvariance2017]
...
[@stapletonConstructMeaningMultilevel2016]
...
::: columns
::: {.column width="50%"}
![](../assets/images/ema.png){fig-align="center"} 
:::
::: {.column width="50%"}
![](../assets/images/statew.png){fig-align="center"}
:::
:::
...
Go to: **`labs/lab10_multilevel_robustse_twolevelcfa.qmd`** [link](https://feracotommaso.github.io/SEM-phd-course/labs/lab10_multilevel_robustse_twolevelcfa.html)
...
![](../assets/images/luca.png){height="7.5cm"}
