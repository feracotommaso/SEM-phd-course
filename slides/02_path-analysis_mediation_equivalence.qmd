...
(because the ($\sigma_M$) cancels)...but `lavaan` does it for you.
...
-   very strong theoretical assumptions

::: {.callout-tip}
For deep dives into causality (and many other things), follow Julia Rohrer and [the100CI blog](https://www.the100.ci/).
:::
...
-   **`labs/lab02_path-mediation.qmd`** [link](lab02_path-mediation.html){target="_blank"}
...
Some blogposts you may like

-   [Reviewer notes: That’s a very nice mediation analysis you have there. It would be a shame if something happened to it.](https://www.the100.ci/2025/03/20/reviewer-notes-thats-a-very-nice-mediation-analysis-you-have-there-it-would-be-a-shame-if-something-happened-to-it/)
-   [Causal Inference \| Hypothesis Testing \| All at Once](https://www.the100.ci/2022/11/18/causal-inference-hypothesis-testing-all-at-once/)
-   [Longitudinal data don’t magically solve causal inference](https://www.the100.ci/2019/04/16/longitudinal-data-dont-magically-solve-causal-inference/)

A paper, still Rohrer [-@rohrer2022]: That’s a Lot to Process! Pitfalls of Popular Path Models [link](https://doi.org/10.1177/25152459221095827)
