...
subtitle: "Measurement + structure (capstone)"
...
already seen in the first [slides](slides/01_sem-foundations_workflow_lavaan.html){target="_blank"}
...
![](../assets/images/lambda.png){width="55%"}

**Beta: regression coefficients**

![](../assets/images/beta.png){width="55%"}
...
The [dataset](https://github.com/feracotommaso/SEM-phd-course/tree/main/data) includes 13 items that measure 'peer pressure', 'social media use', 'social comparison', and 'eating disorders'.
...
-   Thinking twice about sum scores [@mcneishThinkingTwiceSum2020]

-   Thinking thrice about sum scores, and then some more about measurement and analysis [@widamanThinkingThriceSum2022]

-   Psychometric properties of sum scores and factor scores differ even when their correlation is 0.98: A response to Widaman and Revelle [@mcneishPsychometricPropertiesSum2023]

-   Thinking About Sum Scores Yet Again, Maybe the Last Time, We Don’t Know, Oh No [@widamanThinkingSumScores2024]
...
See the [extra module](../extras/ex_indicator-indifference_measurement-robustness.html)

## Exercises (Lab 05)

Go to:

-   **`labs/labs/lab05_sem_capstone_eat.qmd`** [link](https://feracotommaso.github.io/SEM-phd-course/labs/lab05_sem_capstone_eat.html){target="_blank"}
